      ...
      <section className="flex justify-between items-center px-5 mt-5 md:px-20">
        <div className="flex gap-2 md:gap-6">
          <button
            ...
            className={`${typeFilter === "simple" ? "bg-[#E17654] text-white" : "bg-[#FFEAD0]"} w-[84px] h-[37px]  px-4 py-1  rounded-md font-int text-[#4d4d4d]`}
          >
            Simple
          </button>
          <button
            onClick={()=>filter("type","luxury")}
            className={`${typeFilter === "luxury" ? "bg-[#161616] text-white":" bg-[#FFEAD0]" } w-[84px] h-[37px]  px-4 py-1 rounded-md font-int text-[#4d4d4d]`}
          >
            Luxury
          </button>
          <button
            onClick={()=>filter("type","rugged")}
            className={`${typeFilter==="rugged"?"bg-[#115E59] text-white":"bg-[#FFEAD0]"} w-[84px] h-[37px]  px-4 py-1 rounded-md font-int text-[#4d4d4d]`}
          >
            Rugged
          </button>
        </div>
       {typeFilter &&  <button onClick={()=>filter("type",null)} className="text-[#4d4d4d] underline underline-offset-2">
          clear filters
        </button>}
      </section>
